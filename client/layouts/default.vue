<template>
  <div class="min-h-[100dvh] font-poppins text-sm sm:bg-gray-50 select-none">
    ...
    >
      <input
        class="order-2 sm:order-1 bg-[url(/icons/search.svg)] bg-no-repeat bg-[position:99%_60%] transition duration-300 ease-in-out sm:ml-64 w-[90%] sm:w-[550px] h-10 border-none shadow focus:ring-0 sm:focus:scale-[1.01] sm:focus:shadow-lg sm:focus:shadow-black/10 bg-gray-100 rounded-md text-sm"
        type="text"
        ...
        <div class="flex items-center group h-16">
          ...
          <div
            ...
            @click="
              ...
              navigateTo('/');
            "
            class="cursor-pointer flex justify-center transition-visibility duration-300 ease-in-out delay-0 group-hover:delay-200 absolute w-[100px] h-12 invisible group-hover:visible opacity-0 group-hover:opacity-100 bg-white border rounded-lg shadow-xl mt-20 group-hover:mt-24 -ml-8 sm:ml-0 p-3"
          >
            Logout
          </div>
        </div>
